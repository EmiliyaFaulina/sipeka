<aside id="sidebar" class="sidebar bg-primary text-white">
    ...
    <ul class="sidebar-nav bg-white" id="sidebar-nav ">
        ...
        <li class="nav-item"> 
            <a class="nav-link text-black" href="{{url('laila')}}">
        ...
        <li class="nav-item">
            ...
            <ul id="pengajuan-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{url('laila/pengajuan')}}" class="text-black">
        ...
        <li class="nav-item">
            ...
            <ul id="agenda-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <li>
                  <a href="{{url('laila/project')}}" class="text-black">
        ...
        <li class="nav-item">
            ...
            <ul id="laporan-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{url('laila/diterima')}}" class="text-black">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed text-black" href="{{url('laila/profil')}}">
