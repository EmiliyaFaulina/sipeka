<aside id="sidebar" class="sidebar bg-primary text-white">
    ...
    <ul class="sidebar-nav bg-white" id="sidebar-nav ">
        ...
        <li class="nav-item"> 
            <a class="nav-link text-black" href="{{url('emiliya')}}">
        ...
        <li class="nav-item">
            ...
            <ul id="pengajuan-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{url('emiliya/pengajuan')}}" class="text-black">
        ...
        <li class="nav-item">
            ...
            <ul id="laporan-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{url('emiliya/diterima')}}" class="text-black">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed text-black" href="{{url('emiliya/profil')}}">
